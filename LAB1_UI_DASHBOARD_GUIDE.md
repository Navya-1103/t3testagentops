# Lab 1: AgentOps UI Dashboard - Metrics Analysis
...
**Duration:** 60 minutes
**Prerequisites:** Watson Orchestrate account, CLI installed

**Target Audience:** Business users, product managers, and anyone who wants high-level insights into agent performance without diving into code. This lab focuses on the UI dashboard for quick metrics analysis.

> **SPEAKER NOTE:** Lab 1 is designed for non-technical users who want to monitor agent performance through the UI. Lab 2 is for developers/data scientists who need programmatic access to detailed metrics and want to automate testing.
...
> **SPEAKER NOTE:** Explain the importance of realistic usage patterns with time gaps.
...
> **SPEAKER NOTE:** Introduce the two main sections: Evaluation (top) and Analysis (bottom).

---

## Part 4: Evaluation Section (10 minutes)

> **SPEAKER NOTE:** Walk through each chart, highlighting key metrics and patterns.
...
> **SPEAKER NOTE:** Mention this section is being enhanced. Direct attention to Analysis section for detailed tool information.
...
> **SPEAKER NOTE:** Demonstrate drill-down capabilities and message-level analysis.
...
> **SPEAKER NOTE:** Reference [LLM Vulnerability Documentation](https://developer.watson-orchestrate.ibm.com/evaluate/llm_vulnerability) for security analysis.
...
> **SPEAKER NOTE:** Summarize key findings and optimization opportunities.
...
> **SPEAKER NOTE:** Conclude with Q&A and transition to Lab 2.